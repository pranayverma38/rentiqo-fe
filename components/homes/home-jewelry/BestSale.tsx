...
import { bestSaleJewelryProducts } from "@/data/products/products";

function BestSale() {
  return (
    <section className="flat-spacing ">
      <div className="container">
        <div className="sect-heading type-4 align-items-end mb-40">
          <div className="flex-sm-1  wow fadeInUp">
            <h3 className="s-title mb-8">Best Sellers</h3>
            <p className="s-subtitle cl-text-2">
              Most loved jewellery pieces by our customers.
            </p>
          </div>
          <div
        ...
        >
          {bestSaleJewelryProducts.map((product) => (
            <ProductCard
              key={product.img}
              product={product}
              imgWidth={330}
