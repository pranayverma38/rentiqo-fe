...
import { testimonialCosmeticSlides } from "@/data/testimonials";
  ...
  return (
    <section className="flat-spacing">
      <div className="container">
        ...
        >
          {testimonialCosmeticSlides.map((slide, index) => (
            <div
              key={slide.authorImg}
              className="testimonial-v01 style-1 type-3 style-def wow fadeInUp"
            ...
            >
              ...
              <div className="tes-content">
                <div className="star-wrap d-flex align-items-center mb-8">
                  {[...Array(5)].map((_, i) => (
                    <i key={i} className="icon icon-Star fs-24" aria-hidden />
                  ))}
                </div>
                <div className="tes_author mb-16">
                ...
                <p className="tes_text text-body-1">{slide.quote}</p>
                <div className="tes_product gap-20">
